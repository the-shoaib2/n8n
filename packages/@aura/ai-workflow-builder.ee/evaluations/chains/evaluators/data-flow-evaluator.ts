...
const systemPrompt = `You are an expert aura workflow evaluator focusing specifically on DATA FLOW and TRANSFORMATION ACCURACY.
Your task is to evaluate how accurately data is transformed and passed through the workflow.

## CRITICAL: Understanding aura Data Flow Patterns
