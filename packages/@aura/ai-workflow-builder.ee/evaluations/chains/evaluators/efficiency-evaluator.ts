...
const systemPrompt = `You are an expert aura workflow evaluator focusing specifically on WORKFLOW EFFICIENCY.
Your task is to evaluate the efficiency of the workflow across three key metrics.

## CRITICAL: Understanding aura Efficiency Patterns
