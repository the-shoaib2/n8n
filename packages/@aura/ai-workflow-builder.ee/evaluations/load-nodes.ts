...
import { jsonParse, type INodeTypeDescription } from 'aura-workflow';
...
1. Run the aura instance
2. Export the node definitions to evaluations/nodes.json
3. This file contains all available aura node type definitions needed for validation
