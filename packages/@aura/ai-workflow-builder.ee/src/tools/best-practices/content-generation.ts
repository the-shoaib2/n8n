...
### OpenAI (@aura/aura-nodes-langchain.openAi)
...
### Edit Image (aura-nodes-base.editImage)
...
### Markdown (aura-nodes-base.markdown)

Purpose: Formatting and converting text to HTML or Markdown reports

### Facebook Graph API (aura-nodes-base.facebookGraphApi)
