...
ensuring you don't miss data or create infinite loops. Leverage aura's built-in mechanisms rather than manual approaches:
...
### Loop Over Items (Split in Batches) (aura-nodes-base.splitInBatches)
...
### Microsoft Excel 365 (aura-nodes-base.microsoftExcel)

Purpose: Stores scraped data in Excel files for offline analysis

### Airtable (aura-nodes-base.airtable)
...
- Phantombuster (aura-nodes-base.phantombuster)
