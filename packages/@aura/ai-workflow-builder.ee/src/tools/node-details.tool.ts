...
const nodeDetailsSchema = z.object({
	nodeName: z.string().describe('The exact node type name (e.g., aura-nodes-base.httpRequest)'),
...
export function createNodeDetailsTool(nodeTypes: INodeTypeDescription[]) {
	const dynamicTool = tool(
		...
		},
		{
			...
			description:
				'Get detailed information about a specific aura node type including properties and available connections. Use this before adding nodes to understand their input/output structure.',
