...
export function createNodeSearchTool(nodeTypes: INodeTypeDescription[]) {
	const dynamicTool = tool(
		...
		},
		{
			...
			description: `Search for aura nodes by name or find sub-nodes that output specific connection types. Use this before adding nodes to find the correct node types.
