...
describe('NodeSearchTool', () => {
	...
	beforeEach(() => {
		...
		nodeTypesList = [
			...
			createNodeType({
				name: '@aura/aura-nodes-langchain.toolCode',
			...
			createNodeType({
				name: '@aura/aura-nodes-langchain.memoryBufferWindow',
	...
	describe('invoke', () => {
		it('should search nodes by name', async () => {
			...
			expect(message).toContain('<node_name>aura-nodes-base.httpRequest</node_name>');
			expect(message).toContain('<node_name>aura-nodes-base.httpBin</node_name>');
		...
		it('should search sub-nodes by connection type', async () => {
			...
			expect(message).toContain('<node_name>@aura/aura-nodes-langchain.toolCalculator</node_name>');
			expect(message).toContain('<node_name>@aura/aura-nodes-langchain.toolCode</node_name>');
		...
		it('should search sub-nodes with name filter', async () => {
			...
			expect(message).toContain('<node_name>@aura/aura-nodes-langchain.toolCalculator</node_name>');
			expect(message).not.toContain('<node_name>@aura/aura-nodes-langchain.toolCode</node_name>');
		});
		...
		it('should handle multiple queries in a single request', async () => {
			...
			expect(message).toContain('<node_name>@aura/aura-nodes-langchain.lmChatOpenAi</node_name>');
		});
		...
		it('should handle expression-based outputs in sub-node search', async () => {
			...
			expectToolSuccess(content, 'Found');
			expect(message).toContain('<node_name>@aura/aura-nodes-langchain.vectorStore</node_name>');
		});
		...
		it('should handle case-insensitive search', async () => {
			...
			expectToolSuccess(content, 'Found');
			expect(message).toContain('<node_name>aura-nodes-base.code</node_name>');
			expect(message).toContain('<node_name>@aura/aura-nodes-langchain.toolCode</node_name>');
		});
		...
		it('should include all node details in results', async () => {
			...
			expect(message).toContain('<node_name>aura-nodes-base.webhook</node_name>');
			expect(message).toContain(
