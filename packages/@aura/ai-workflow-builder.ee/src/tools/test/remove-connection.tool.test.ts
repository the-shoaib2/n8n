...
describe('RemoveConnectionTool', () => {
	...
	describe('invoke', () => {
		...
		it('should remove connection at specific output/input indices', async () => {
			const existingWorkflow = createWorkflow([
				createNode({ id: 'node1', name: 'If', type: 'aura-nodes-base.if' }),
				createNode({ id: 'node2', name: 'Set', type: 'aura-nodes-base.set' }),
			]);
		...
		it('should handle removing one connection when multiple exist', async () => {
			const existingWorkflow = createWorkflow([
				createNode({ id: 'node1', name: 'Code', type: 'aura-nodes-base.code' }),
				createNode({ id: 'node2', name: 'Set 1', type: 'aura-nodes-base.set' }),
				createNode({ id: 'node3', name: 'Set 2', type: 'aura-nodes-base.set' }),
			]);
		...
		it('should return error when specific connection does not exist', async () => {
			const existingWorkflow = createWorkflow([
				createNode({ id: 'node1', name: 'Code', type: 'aura-nodes-base.code' }),
				createNode({ id: 'node2', name: 'HTTP Request', type: 'aura-nodes-base.httpRequest' }),
				createNode({ id: 'node3', name: 'Set', type: 'aura-nodes-base.set' }),
			]);
