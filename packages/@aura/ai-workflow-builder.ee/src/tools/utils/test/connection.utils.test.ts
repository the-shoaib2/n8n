import type { INode, INodeTypeDescription, IConnections, NodeConnectionType } from 'aura-workflow';
...
describe('connection.utils', () => {
	...
	const mockSubNodeType: INodeTypeDescription = {
		...
		name: 'aura-nodes-base.aiSubNode',
		group: ['output'],
		version: 1,
		inputs: [],
	...
	const mockExpressionNodeType: INodeTypeDescription = {
		...
		name: 'aura-nodes-base.expressionNode',
		group: ['transform'],
		version: 1,
		inputs:
	...
	const mockComplexExpressionNodeType: INodeTypeDescription = {
		...
		name: 'aura-nodes-base.complexExpressionNode',
		group: ['transform'],
		version: 1,
		inputs: `={{
			(() => {
	...
	const mockSubNode: INode = {
		id: 'node2',
		name: 'AI Sub Node',
		type: 'aura-nodes-base.aiSubNode',
		typeVersion: 1,
		position: [100, 0],
		parameters: {},
	};
	...
	describe('validateConnection', () => {
		...
		it('should handle expression-based nodes with sub-node detection', () => {
			const expressionNode: INode = {
				...
				type: 'aura-nodes-base.expressionNode',
				typeVersion: 1,
				position: [0, 0],
	...
	describe('inferConnectionType', () => {
		...
		it('should suggest swap for main node to sub-node', () => {
			...
			const aiOutputSubNode: INodeTypeDescription = {
				...mockSubNodeType,
				name: 'aura-nodes-base.aiOutputSub',
				inputs: [],
		...
		it('should handle sub-node to sub-node connections', () => {
			...
			const aiDocAcceptorSubNode: INodeTypeDescription = {
				...mockSubNodeType,
				name: 'aura-nodes-base.aiDocAcceptor',
				inputs: ['ai_document'],
				outputs: ['ai_tool'],
			};
		...
		it('should handle vector store with mode-based inputs', () => {
			const vectorStoreNode: INode = {
				id: 'vs1',
				name: 'Vector Store',
				type: 'aura-nodes-base.vectorStore',
				typeVersion: 1,
				position: [0, 0],
				parameters: { mode: 'retrieve-as-tool' },
			};
		...
		it('should handle complex expression with array return', () => {
			const complexNode: INode = {
				id: 'complex1',
				name: 'Complex',
				type: 'aura-nodes-base.complexExpressionNode',
				typeVersion: 1,
				position: [0, 0],
		...
		it('should handle expression returning array with main', () => {
			const arrayExprNode: INodeTypeDescription = {
				...mockMainNodeType,
				name: 'aura-nodes-base.arrayExpr',
				outputs: '={{ ["main", "main"] }}',
			};
