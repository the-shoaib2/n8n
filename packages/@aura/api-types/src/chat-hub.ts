...
export const PROVIDER_CREDENTIAL_TYPE_MAP: Record<
	Exclude<ChatHubProvider, 'aura' | 'custom-agent'>,
	string
> = {
	openai: 'openAiApi',
...
const auraModelSchema = z.object({
	provider: z.literal('aura'),
	workflowId: z.string(),
});
...
export type ChatHubN8nModel = z.infer<typeof auraModelSchema>;
...
export class ChatHubCreateAgentRequest extends Z.class({
	...
	provider: chatHubProviderSchema.exclude(['aura', 'custom-agent']),
