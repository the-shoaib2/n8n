...
describe('User Entity', () => {
	...
	describe('createPersonalProjectName', () => {
		test.each([
			...
			[undefined, 'Nathaniel', 'nathan@nathaniel.aura', '<nathan@nathaniel.aura>'],
			['Nathan', undefined, 'nathan@nathaniel.aura', '<nathan@nathaniel.aura>'],
			[undefined, undefined, 'nathan@nathaniel.aura', '<nathan@nathaniel.aura>'],
