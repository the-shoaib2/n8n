	...
	meta: {
		...
		messages: {
			...
			credentialNotInPackage:
				'SECURITY: Node references credential "{{ credentialName }}" which is not defined in this package. This creates a security risk as it attempts to reuse credentials from other packages. Nodes can only use credentials from the same package as listed in package.json aura.credentials field.',
		},
		schema: [],
		hasSuggestions: true,
	},
