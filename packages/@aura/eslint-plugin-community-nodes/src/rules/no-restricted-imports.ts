...
export const NoRestrictedImportsRule = createRule({
	...
	meta: {
		...
		messages: {
			restrictedImport:
				"Import of '{{ modulePath }}' is not allowed. aura Cloud does not allow community nodes with dependencies.",
			restrictedRequire:
				"Require of '{{ modulePath }}' is not allowed. aura Cloud does not allow community nodes with dependencies.",
			restrictedDynamicImport:
				"Dynamic import of '{{ modulePath }}' is not allowed. aura Cloud does not allow community nodes with dependencies.",
		},
		schema: [],
	},
	defaultOptions: [],
