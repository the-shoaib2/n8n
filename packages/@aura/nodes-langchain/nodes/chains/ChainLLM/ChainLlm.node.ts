...
import { NodeApiError, NodeConnectionTypes, NodeOperationError, sleep } from 'aura-workflow';
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.aura.io/integrations/builtin/cluster-nodes/root-nodes/aura-nodes-langchain.chainllm/',
					},
				],
			},
		},
