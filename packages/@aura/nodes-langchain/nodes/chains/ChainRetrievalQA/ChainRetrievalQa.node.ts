import { NodeConnectionTypes, parseErrorMetadata, sleep } from 'aura-workflow';
import {
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.aura.io/integrations/builtin/cluster-nodes/root-nodes/aura-nodes-langchain.chainretrievalqa/',
					},
				],
			},
		},
