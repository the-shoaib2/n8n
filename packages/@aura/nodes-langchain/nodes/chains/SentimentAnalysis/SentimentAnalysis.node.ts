...
import { NodeConnectionTypes, NodeOperationError, sleep } from 'aura-workflow';
import type {
	IDataObject,
	IExecuteFunctions,
	INodeExecutionData,
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.aura.io/integrations/builtin/cluster-nodes/root-nodes/aura-nodes-langchain.sentimentanalysis/',
					},
				],
			},
		},
