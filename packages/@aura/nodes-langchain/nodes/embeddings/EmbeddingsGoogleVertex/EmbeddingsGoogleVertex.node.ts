...
import { formatPrivateKey } from 'aura-nodes-base/dist/utils/utilities';
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.aura.io/integrations/builtin/cluster-nodes/sub-nodes/aura-nodes-langchain.embeddingsgooglevertex/',
					},
				],
			},
		},
