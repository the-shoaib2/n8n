	...
	description: INodeTypeDescription = {
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.aura.io/integrations/builtin/cluster-nodes/sub-nodes/aura-nodes-langchain.lmchatopenai/',
					},
				],
			},
		},
		...
		properties: [
			...
			},
			{
				...
				default: true,
				description:
					'Whether to use the Responses API to generate the response. <a href="https://docs.aura.io/integrations/builtin/cluster-nodes/sub-nodes/aura-nodes-langchain.lmchatopenai/#use-responses-api">Learn more</a>.',
				displayOptions: {
					show: {
						...
						options: [
							{
								...
								name: 'vectorStoreIds',
								description:
									'The vector store IDs to use for the file search. Vector stores are managed via OpenAI Dashboard. <a href="https://docs.aura.io/integrations/builtin/cluster-nodes/sub-nodes/aura-nodes-langchain.lmchatopenai/#built-in-tools">Learn more</a>.',
								type: 'json',
								default: '[]',
								required: true,
							},
