...
import type { IDataObject, INode, ISupplyDataFunctions } from 'aura-workflow';
...
jest.mock('../auraLlmFailedAttemptHandler');
	...
	describe('methods', () => {
		...
		it('should force Responses API and include additional params for v1.3', async () => {
			...
			const options: IDataObject = {
				...
				promptConfig: {
					promptOptions: [{ promptId: 'p_1', version: '1', variables: '{"name":"aura"}' }],
				},
			};
