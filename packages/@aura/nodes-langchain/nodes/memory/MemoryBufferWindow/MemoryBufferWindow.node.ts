...
export class MemoryBufferWindow implements INodeType {
	description: INodeTypeDescription = {
		...
		description: 'Stores in aura memory, so no credentials required',
		defaults: {
			name: 'Simple Memory',
		},
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.aura.io/integrations/builtin/cluster-nodes/sub-nodes/aura-nodes-langchain.memorybufferwindow/',
					},
				],
			},
		},
