...
import { JsTaskRunnerSandbox } from 'aura-nodes-base/dist/nodes/Code/JsTaskRunnerSandbox';
import { PythonSandbox } from 'aura-nodes-base/dist/nodes/Code/PythonSandbox';
import type { Sandbox } from 'aura-nodes-base/dist/nodes/Code/Sandbox';
	...
	description: INodeTypeDescription = {
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.aura.io/integrations/builtin/cluster-nodes/sub-nodes/aura-nodes-langchain.toolcode/',
					},
				],
			},
		},
		...
		properties: [
			...
			},
			{
				...
				// eslint-disable-next-line aura-nodes-base/node-param-description-missing-final-period
