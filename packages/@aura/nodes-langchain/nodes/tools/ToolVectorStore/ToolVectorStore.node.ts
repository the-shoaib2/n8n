...
import { NodeConnectionTypes, nodeNameToToolName } from 'aura-workflow';
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.aura.io/integrations/builtin/cluster-nodes/sub-nodes/aura-nodes-langchain.toolvectorstore/',
					},
				],
			},
		},
