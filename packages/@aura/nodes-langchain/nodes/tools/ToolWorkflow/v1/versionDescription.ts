...
export const versionDescription: INodeTypeDescription = {
	displayName: 'Call aura Workflow Tool',
	name: 'toolWorkflow',
	group: ['transform'],
	version: [1, 1.1, 1.2, 1.3],
	description: 'Uses another aura workflow as a tool. Allows packaging any aura node(s) as a tool.',
	defaults: {
		name: 'Call aura Workflow Tool',
	},
	codex: {
		categories: ['AI'],
		subcategories: {
	...
	properties: [
		...
		// ----------------------------------
		{
			...
			description:
				'Where to find the data that this tool should return. aura will look in the output of the last-executed node of the workflow for a field with this name, and return its value.',
			displayOptions: {
				show: {
					'@version': [{ _cnd: { lt: 1.3 } }],
				},
