...
import type { SetField, SetNodeOptions } from 'aura-nodes-base/dist/nodes/Set/v2/helpers/interfaces';
import * as manual from 'aura-nodes-base/dist/nodes/Set/v2/manual.mode';
import { getCurrentWorkflowInputData } from 'aura-nodes-base/dist/utils/workflowInputsResourceMapping/GenericFunctions';
import type {
	ExecuteWorkflowData,
	ExecutionError,
	FromAIArgument,
...
/**
	...
	Processes the node parameters and creates AI Agent tool capable of executing aura workflows
*/
