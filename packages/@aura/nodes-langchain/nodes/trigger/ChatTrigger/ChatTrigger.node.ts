...
export class ChatTrigger extends Node {
	description: INodeTypeDescription = {
		...
		defaultVersion: 1.4,
		description: 'Runs the workflow when an aura generated webchat is submitted',
		defaults: {
		...
		properties: [
				...
				options: [
					{
						name: 'Hosted Chat',
						value: 'hostedChat',
						description: 'Chat on a page served by aura',
					},
					{
						name: 'Embedded Chat',
						value: 'webhook',
			...
			{
				displayName:
					'Follow the instructions <a href="https://www.npmjs.com/package/@aura/chat" target="_blank">here</a> to embed chat in a webpage (or just call the webhook URL at the top of this section). Chat will be live once you activate this workflow',
			...
			},
			{
				...
				options: [
					...
					},
					{
						...
						name: 'aura User Auth',
						value: 'auraUserAuth',
						description: 'Require user to be logged in with their aura account',
					},
					{
						name: 'None',
						value: 'none',
			...
			{
				// eslint-disable-next-line aura-nodes-base/node-param-display-name-miscased
				displayName: 'Make Available in aura Chat',
				name: 'availableInChat',
				type: 'boolean',
				default: false,
				noDataExpression: true,
				description: 'Whether to make the agent available in aura Chat',
				displayOptions: {
					show: {
			...
			},
			{
				...
				default: '',
				noDataExpression: true,
				description: 'The name of the agent on aura Chat',
				displayOptions: {
					show: {
			...
			},
			{
				...
				default: '',
				noDataExpression: true,
				description: 'The description of the agent on aura Chat',
				displayOptions: {
					show: {
						availableInChat: [true],
					},
