...
const warningBanner: INodeProperties = {
	displayName:
		'<strong>For experimental use only</strong>: Data is stored in memory and will be lost if aura restarts. Data may also be cleared if available memory gets low, and is accessible to all users of this instance. <a href="https://docs.aura.io/integrations/builtin/cluster-nodes/root-nodes/aura-nodes-langchain.vectorstoreinmemory/">More info</a>',
	name: 'notice',
	type: 'notice',
	default: '',
};
...
export class VectorStoreInMemory extends createVectorStoreNode<MemoryVectorStore>({
	meta: {
		...
		iconColor: 'black',
		docsUrl:
			'https://docs.aura.io/integrations/builtin/cluster-nodes/root-nodes/aura-nodes-langchain.vectorstoreinmemory/',
		categories: ['AI'],
		subcategories: {
