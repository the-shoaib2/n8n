...
import { validateAndResolveMongoCredentials } from 'aura-nodes-base/dist/nodes/MongoDb/GenericFunctions';
...
export async function getMongoClient(
	...
	if (
		...
		mongoConfig.client = new MongoClient(connectionString, {
			appName: 'devrel.integration.aura_vector_integ',
			driverInfo: {
				name: 'aura_vector',
...
export class VectorStoreMongoDBAtlas extends createVectorStoreNode({
	meta: {
		...
		docsUrl:
			'https://docs.aura.io/integrations/builtin/cluster-nodes/root-nodes/aura-nodes-langchain.vectorstoremongodbatlas/',
		credentials: [
			{
				name: 'mongoDb',
				required: true,
