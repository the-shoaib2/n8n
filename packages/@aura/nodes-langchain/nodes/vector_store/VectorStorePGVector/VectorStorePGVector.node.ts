...
const collectionField: INodeProperties = {
	...
	default: {
		values: {
			useCollection: false,
			collectionName: 'aura',
			collectionTable: 'aura_vector_collections',
		},
	},
	typeOptions: {},
	...
	options: [
		{
			...
			values: [
				...
				},
				{
					...
					type: 'string',
					default: 'aura_vector_collections',
					required: true,
					displayOptions: { show: { useCollection: [true] } },
				},
			],
...
export class VectorStorePGVector extends createVectorStoreNode<ExtendedPGVectorStore>({
	meta: {
		...
		docsUrl:
			'https://docs.aura.io/integrations/builtin/cluster-nodes/root-nodes/aura-nodes-langchain.vectorstorepgvector/',
