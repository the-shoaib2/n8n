...
import { assertParamIsString, type IDataObject, type INodeProperties } from 'aura-workflow';
...
export class VectorStoreQdrant extends createVectorStoreNode<ExtendedQdrantVectorStore>({
	meta: {
		...
		docsUrl:
			'https://docs.aura.io/integrations/builtin/cluster-nodes/root-nodes/aura-nodes-langchain.vectorstoreqdrant/',
		credentials: [
			{
				name: 'qdrantApi',
				required: true,
