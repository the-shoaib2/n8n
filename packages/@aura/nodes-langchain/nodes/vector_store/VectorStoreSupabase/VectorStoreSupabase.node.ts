...
import { NodeOperationError, type INodeProperties } from 'aura-workflow';
...
export class VectorStoreSupabase extends createVectorStoreNode<SupabaseVectorStore>({
	meta: {
		...
		docsUrl:
			'https://docs.aura.io/integrations/builtin/cluster-nodes/root-nodes/aura-nodes-langchain.vectorstoresupabase/',
