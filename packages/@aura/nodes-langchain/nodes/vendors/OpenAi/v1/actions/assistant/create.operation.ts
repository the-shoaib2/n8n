...
import { NodeOperationError, updateDisplayOptions } from 'aura-workflow';
...
const properties: INodeProperties[] = [
	...
	{
		displayName:
			'Add custom aura tools when you <i>message</i> your assistant (rather than when creating it)',
		name: 'noticeTools',
		type: 'notice',
		default: '',
	},
