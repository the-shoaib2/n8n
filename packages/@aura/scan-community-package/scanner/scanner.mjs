...
const analyzePackage = async (packageDir) => {
	const { auraCommunityNodesPlugin } = await import('@aura/eslint-plugin-community-nodes');
	const eslint = new ESLint({
		cwd: packageDir,
		allowInlineConfig: false,
		overrideConfigFile: true,
		overrideConfig: defineConfig(auraCommunityNodesPlugin.configs.recommended),
	});
