...
describe('css-var-naming rule', () => {
	describe('namespace validation', () => {
		it('should accept valid aura namespace', async () => {
			const namespacePattern = `
				:root {
					--aura--color--primary: #0d6efd;
					--aura--button--color--background--primary: #0d6efd;
					--aura--button--color--background--primary--hover: #0b5ed7;
					--aura--color--text--muted: #888;
				}
			`;
		...
		it('should allow non-namespace first groups (components)', async () => {
			...
			// It only recognizes 'aura' and 'chat' as namespaces for property checking
		...
		it('should accept namespace with component and states', async () => {
			const complexNamespace = `
				:root {
					--aura--button--color--background--primary--solid--hover: #0b5ed7;
		...
		it('should accept namespace with all 8 groups', async () => {
			const maxGroups = `
				:root {
					--aura--button--part--color--text--primary--solid--hover--dark: #000;
				}
			`;
