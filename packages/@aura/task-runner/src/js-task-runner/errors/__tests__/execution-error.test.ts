...
describe('ExecutionError', () => {
    ...
    at JsTaskRunner.runForAllItems (/aura/packages/@aura/task-runner/dist/js-task-runner/js-task-runner.js:90:65)
    at JsTaskRunner.executeTask (/aura/packages/@aura/task-runner/dist/js-task-runner/js-task-runner.js:71:26)
    at process.processTicksAndRejections (node:internal/process/task_queues:95:5)
    at async JsTaskRunner.receivedSettings (/aura/packages/@aura/task-runner/dist/task-runner.js:190:26)`;
