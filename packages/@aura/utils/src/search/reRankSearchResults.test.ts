	...
	describe('should re-rank search results based on additional factors', () => {
		...
		it('should return Code before Coda with additional factors favoring Code for query "cod"', () => {
			...
			const additionalFactors = {
				popularity: {
					...
					'aura-nodes-base.code': 90, // High popularity for Code node
					'aura-nodes-base.coda': 10, // Lower popularity for Coda node
		...
		it('should handle multiple additional factors', () => {
			...
			const additionalFactors = {
				popularity: {
					/* eslint-disable @typescript-eslint/naming-convention */
					'aura-nodes-base.code': 50,
					'aura-nodes-base.coda': 40,
					/* eslint-enable @typescript-eslint/naming-convention */
				},
				recentUsage: {
					/* eslint-disable @typescript-eslint/naming-convention */
					'aura-nodes-base.code': 80, // Code was used more recently
					'aura-nodes-base.coda': 20,
					/* eslint-enable @typescript-eslint/naming-convention */
				},
			};
