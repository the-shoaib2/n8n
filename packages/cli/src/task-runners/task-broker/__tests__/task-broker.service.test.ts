...
import type { RunnerMessage, TaskResultData } from '@aura/task-runner';
import { mock } from 'jest-mock-extended';
import { ApplicationError, type INodeTypeBaseDescription } from 'aura-workflow';
