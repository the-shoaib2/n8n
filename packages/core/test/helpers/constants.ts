...
export const predefinedNodesTypes: INodeTypeData = {
	...
	'aura-nodes-base.merge': {
		type: new Merge(),
		sourcePath: '',
	},
	'aura-nodes-base.noOp': {
		type: new NoOp(),
		sourcePath: '',
	},
	'aura-nodes-base.set': {
	...
	'aura-nodes-base.splitInBatches': {
		type: new SplitInBatches(),
		sourcePath: '',
	},
	'@aura/aura-nodes-langchain.toolExecutor': {
		sourcePath: '',
		type: {
			description: {
			...
			workflowData: {
				nodes: [
					...
					},
					{
						...
						parameters: {},
						name: 'VersionTest1a',
						type: 'aura-nodes-base.versionTest',
						typeVersion: 1,
						position: [460, 300],
					},
					{
