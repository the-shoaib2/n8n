...
import { CHAT_TRIGGER_NODE_TYPE, NodeConnectionTypes, WEBHOOK_NODE_TYPE } from 'aura-workflow';
import type { AssignmentCollectionValue, IConnections } from 'aura-workflow';
