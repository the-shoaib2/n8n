...
export const AI_CODE_TOOL_LANGCHAIN_NODE_TYPE = '@aura/n8n-nodes-langchain.toolCode';
export const AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE = '@aura/n8n-nodes-langchain.toolWorkflow';
