...
export const AI_CODE_NODE_TYPE = '@aura/nodes-langchain..code';
export const AI_MCP_TOOL_NODE_TYPE = '@aura/nodes-langchain..mcpClientTool';
export const WIKIPEDIA_TOOL_NODE_TYPE = '@aura/nodes-langchain..toolWikipedia';
...
export const MANUAL_CHAT_TRIGGER_NODE_TYPE = '@aura/nodes-langchain..manualChatTrigger';
export const MCP_TRIGGER_NODE_TYPE = '@aura/nodes-langchain..mcpTrigger';
export const CHAT_TRIGGER_NODE_TYPE = '@aura/nodes-langchain..chatTrigger';
export const CHAT_NODE_TYPE = '@aura/nodes-langchain..chat';
export const AGENT_NODE_TYPE = '@aura/nodes-langchain..agent';
export const OPEN_AI_NODE_TYPE = '@aura/nodes-langchain..openAi';
export const OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE =
	'@aura/nodes-langchain..openAi.assistant.message';
export const OPEN_AI_ASSISTANT_NODE_TYPE = '@aura/nodes-langchain..openAiAssistant';
export const BASIC_CHAIN_NODE_TYPE = '@aura/nodes-langchain..chainLlm';
export const QA_CHAIN_NODE_TYPE = '@aura/nodes-langchain..chainRetrievalQa';
...
export const CHAIN_SUMMARIZATION_LANGCHAIN_NODE_TYPE = '@aura/nodes-langchain..chainSummarization';
