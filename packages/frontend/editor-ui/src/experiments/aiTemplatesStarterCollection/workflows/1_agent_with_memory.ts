	...
	nodes: [
		{
			...
			type: '@aura/nodes-langchain..chatTrigger',
			typeVersion: 1.1,
			position: [0, 0],
			parameters: {
				options: {},
		...
		},
		{
			...
			name: 'AI Agent',
			type: '@aura/nodes-langchain..agent',
			typeVersion: 2.1,
			position: [208, 0],
			parameters: {
				options: {
