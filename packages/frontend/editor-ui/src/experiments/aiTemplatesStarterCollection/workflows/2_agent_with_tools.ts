...
export const AGENT_WITH_TOOLS: WorkflowDataCreate = {
	...
	nodes: [
		...
		{
			parameters: {},
			type: '@aura/nodes-langchain..toolCalculator',
			typeVersion: 1,
			position: [624, 288],
