...
import type { INodePropertyTypeOptions, ResourceMapperFields } from 'aura-workflow';
import { computed, ref, watch } from 'vue';
import { i18n as locale } from '@aura/i18n';
import { useNodeSpecificationValues } from '../../composables/useNodeSpecificationValues';
import { N8nIcon, N8nInputLabel, N8nLink, N8nOption, N8nSelect, N8nText } from '@aura/design-system';
interface Props {
	initialValue: string;
