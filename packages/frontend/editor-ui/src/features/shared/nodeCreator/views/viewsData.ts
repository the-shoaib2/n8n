...
import type { INodeTypeDescription, NodeConnectionType, Themed } from 'aura-workflow';
import { EVALUATION_TRIGGER_NODE_TYPE, NodeConnectionTypes } from 'aura-workflow';
