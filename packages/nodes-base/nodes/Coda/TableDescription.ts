...
export const tableFields: INodeProperties[] = [
	...
	},
	{
		...
		description:
			'The table to create the row in. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
	},
	{
		displayName: 'Options',
		name: 'options',
	...
	},
	{
		...
		description:
			'The table to get the row from. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
	},
	{
		displayName: 'Row ID',
		name: 'rowId',
	...
	},
	{
		...
		description:
			'The table to get the rows from. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
	},
	{
	...
	},
	{
		...
		description:
			'The table to delete the row in. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
	},
	{
		displayName: 'Row ID',
		name: 'rowId',
