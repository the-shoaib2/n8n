	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				description:
					'ID of the business that the account belongs to. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'City',
				name: 'city',
			...
			},
			{
				...
				description:
					'ID of the industry that the account belongs to. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
			},
			{
			...
			},
			{
				...
				description:
					'ID of the user to whom the account is assigned. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
			},
			{
			...
			},
			{
				...
				description:
					'ID of the territory that the account belongs to. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Twitter',
				name: 'twitter',
