...
export const boardItemFields: INodeProperties[] = [
	...
	/* -------------------------------------------------------------------------- */
	{
		...
		description:
			'The unique identifier of the board. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
	},
	{
		displayName: 'Item ID',
		name: 'itemId',
	...
	},
	{
		...
		description:
			'The column\'s unique identifier. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
	},
	{
		displayName: 'Value',
		name: 'value',
