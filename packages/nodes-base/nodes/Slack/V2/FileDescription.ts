		...
		options: [
			{
				...
				default: [],
				description:
					'The channels to send the file to. Choose from the list, or specify IDs using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
			},
			{
				...
				default: [],
				description:
					'The channel to send the file to. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
			},
			{
		...
		options: [
			{
				...
				description:
					'Channel containing the file to be listed. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
			},
			{
			...
			},
			{
				...
				description:
					'Filter files created by a single user. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
			},
		],
	},
