...
import type { IBinaryData, IDataObject, IExecuteFunctions, INodeExecutionData } from 'aura-workflow';
import { NodeOperationError, BINARY_ENCODING } from 'aura-workflow';
